...
urlpatterns = [
    ...
    path("temp_registration_done/<token>/resend",
    ...
    path("password_reset/<token>/resend",
    ...
    path("video_play/<int:pk>", 
        views.PlayVideoView.as_view(),
        name="video_play",
    ),
    path("account/<int:pk>",
    ...
    path("email_reset",
        views.EmailResetView.as_view(),
        name="email_reset",
    ),
    path("email_reset_confirmation/<token>",
        views.EmailResetConfirmationView.as_view(),
        name="email_reset_confirmation",
    ),
    path("email_reset_confirmation/<token>/resend",
    ...
    path("video_update/<int:pk>",
         views.VideoUpdateView.as_view(),
         name="video_update",
    ),
    path("video_delete/<int:pk>",
         views.video_delete,
         name="video_delete",
    ),
]